...
void init(int width, int height, std::string strTitle, bool bFullScreen) {
	...
	modelLampBeacon.loadModel("../models/Street_Beacon/Linterna.obj");
	modelLampBeacon.setShader(&shaderMulLighting);
...
void applicationLoop() {
	...
	modelMatrixEclipse = glm::translate(modelMatrixEclipse, glm::vec3(15.0, 0.0, 10.0));
	...
	modelMatrixFrontalWheels = glm::translate(modelMatrixFrontalWheels, glm::vec3(0.0, -1.05813, -4.11483));*/
	modelEclipseFrontalWheels.render(modelMatrixEclipseChasis);
	...
	modelMatrixRearWheels = glm::translate(modelMatrixRearWheels, glm::vec3(0.0, -1.05813, 4.35157));*/
	modelEclipseRearWheels.render(modelMatrixEclipseChasis);
	...
	while (psi) {
		...
		shaderMulLighting.setVectorFloat3("spotLights[0].light.diffuse", glm::value_ptr(glm::vec3(0.6, 0.4, 0.2)));
		...
		shaderTerrain.setVectorFloat3("spotLights[0].light.diffuse", glm::value_ptr(glm::vec3(0.6, 0.4, 0.2)));
		...
		//Faros del auto 
		//modelMatrixEclipse * glm::vec4(0.766, 0.618, 2.334, 1.0)
		//glm::vec3(0, 0, -0.6)
		spotPosition = glm::vec3(modelMatrixEclipse * glm::vec4(0.766, 1.618, 2.334, 1.0));
		...
		shaderMulLighting.setVectorFloat3("spotLights[1].direction", glm::value_ptr(modelMatrixEclipse[2]));
		...
		shaderTerrain.setVectorFloat3("spotLights[1].direction", glm::value_ptr(modelMatrixEclipse[2]));
		...
		shaderMulLighting.setVectorFloat3("spotLights[2].direction", glm::value_ptr(modelMatrixEclipse[2]));
		...
		shaderTerrain.setVectorFloat3("spotLights[2].direction", glm::value_ptr(modelMatrixEclipse[2]));
		...
		for(int i = 0; i < lamp1Position.size(); i++){
			...
			matrixAdjustLamp = glm::translate(matrixAdjustLamp, glm::vec3(0.0, 10.55, 0));
		...
		size_t c_pos = lamp1Position.size();
		for(int i = 0; i < lamp2Position.size(); i++){
			...
			glm::vec3 lampPosition = glm::vec3(matrixAdjustLamp[3]);
			shaderMulLighting.setVectorFloat3("pointLights[" + std::to_string(c_pos + i) + "].light.ambient", glm::value_ptr(glm::vec3(0.2, 0.16, 0.01)));
			shaderMulLighting.setVectorFloat3("pointLights[" + std::to_string(c_pos + i) + "].light.diffuse", glm::value_ptr(glm::vec3(0.4, 0.32, 0.02)));
			shaderMulLighting.setVectorFloat3("pointLights[" + std::to_string(c_pos + i) + "].light.specular", glm::value_ptr(glm::vec3(0.6, 0.58, 0.03)));
			shaderMulLighting.setVectorFloat3("pointLights[" + std::to_string(c_pos + i) + "].position", glm::value_ptr(lampPosition));
			shaderMulLighting.setFloat("pointLights[" + std::to_string(c_pos + i) + "].constant", 1.0);
			shaderMulLighting.setFloat("pointLights[" + std::to_string(c_pos + i) + "].linear", 0.09);
			shaderMulLighting.setFloat("pointLights[" + std::to_string(c_pos + i) + "].quadratic", 0.02);
			shaderTerrain.setVectorFloat3("pointLights[" + std::to_string(c_pos + i) + "].light.ambient", glm::value_ptr(glm::vec3(0.2, 0.16, 0.01)));
			shaderTerrain.setVectorFloat3("pointLights[" + std::to_string(c_pos + i) + "].light.diffuse", glm::value_ptr(glm::vec3(0.4, 0.32, 0.02)));
			shaderTerrain.setVectorFloat3("pointLights[" + std::to_string(c_pos + i) + "].light.specular", glm::value_ptr(glm::vec3(0.6, 0.58, 0.03)));
			shaderTerrain.setVectorFloat3("pointLights[" + std::to_string(c_pos + i) + "].position", glm::value_ptr(lampPosition));
			shaderTerrain.setFloat("pointLights[" + std::to_string(c_pos + i) + "].constant", 1.0);
			shaderTerrain.setFloat("pointLights[" + std::to_string(c_pos + i) + "].linear", 0.09);
			shaderTerrain.setFloat("pointLights[" + std::to_string(c_pos + i) + "].quadratic", 0.02);
		}
		c_pos = lamp1Position.size() + lamp2Position.size();
		for(int i = 0; i < lamp3Position.size(); i++){
			...
			matrixAdjustLamp = glm::scale(matrixAdjustLamp, glm::vec3(0.5));
			matrixAdjustLamp = glm::translate(matrixAdjustLamp, glm::vec3(0.0, 1.0, 0));
			glm::vec3 lampPosition = glm::vec3(matrixAdjustLamp[3]);
			shaderMulLighting.setVectorFloat3("pointLights[" + std::to_string(c_pos + i) + "].light.ambient", glm::value_ptr(glm::vec3(0.2, 0.16, 0.01)));
			shaderMulLighting.setVectorFloat3("pointLights[" + std::to_string(c_pos + i) + "].light.diffuse", glm::value_ptr(glm::vec3(0.4, 0.32, 0.02)));
			shaderMulLighting.setVectorFloat3("pointLights[" + std::to_string(c_pos + i) + "].light.specular", glm::value_ptr(glm::vec3(0.6, 0.58, 0.03)));
		...
		glm::mat4 modelMatrixLamboChasis = glm::mat4(modelMatrixEclipse);
		...
		for(int i = 0; i < lamp3Position.size(); i++){
			...
			modelLampBeacon.setPosition(lamp3Position[i]);
			modelLampBeacon.setScale(glm::vec3(1));
			modelLampBeacon.setOrientation(glm::vec3(0, lamp3Orientation[i], 0));
			modelLampBeacon.render();
		}
		// Dart lego
		...
		// Maquina de estado de lambo Desactivar animacion de puertas
		/*switch (stateDoor)
		{
		case 0:
			dorRotCount += 0.5;
